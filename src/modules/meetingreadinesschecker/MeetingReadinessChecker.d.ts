...
export default interface MeetingReadinessChecker {
     ...
     */
    checkAudioOutput(audioInputDeviceInfo: MediaDeviceInfo, audioOutputVerificationCallback: () => Promise<boolean>, audioElement?: HTMLAudioElement): Promise<CheckAudioOutputFeedback>;
    /**
